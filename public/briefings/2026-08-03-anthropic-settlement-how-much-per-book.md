...
The certified class covers **482,460 works** on the settlement's Works List — books with an ISBN or ASIN that were downloaded by Anthropic from the pirate libraries LibGen and PiLiMi, with a U.S. copyright registration within five years of publication. Divide the $1.5 billion fund (plus interest it earns) across those works and you get roughly $3,100 gross per work. The court's final approval order confirmed the \~$3,000 estimate and noted it is **4× the statutory minimum** damages for infringement.
...
- **Fund interest.** The $1.5 billion accrues interest until fully distributed — the fund is non-reversionary, meaning none of it goes back to Anthropic.
- **The claims rate.** 91.3% of works were claimed as of April 2026 — extraordinarily high, but the residue from unclaimed works stays in the fund for distribution.
...
- [Bartz v. Anthropic Settlement Receives Final Approval](https://www.authorsalliance.org/2026/07/21/bartz-v-anthropic-settlement-receives-final-approval/) — Authors Alliance, July 21, 2026 (fee award detail)
