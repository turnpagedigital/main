...
Only someone with standing — in practice, one of the **53 objectors** whose objections the court overruled on July 20. The court addressed every docketed objection on the merits rather than dismissing them procedurally, which strengthens the order on appeal. The **350 class members who opted out** (representing 1,802 works, about 0.03% of the class) gave up their stake in the settlement and generally have nothing to appeal; they're pursuing their own suits instead — the *Chicken Soup for the Soul* and Carreyrou actions are already on file.

## What happens to payments if someone appeals

An appeal of a class settlement approval typically doesn't unwind the deal — appellate courts affirm the vast majority of approved settlements — but it can **pause distribution** while the appeal is pending, because administrators won't pay out a fund whose approval might be vacated. Ninth Circuit appeals commonly take 12–18 months to resolve. That's the risk: not that the money disappears, but that "checks this fall" becomes "checks after the mandate issues."

Some settlements distribute to the uncontested portion of the class during an appeal; whether that happens here would depend on the administrator's and court's handling. No one should assume it.
...
- [Order on Final Approval — Bartz v. Anthropic (PDF)](https://cdn.arstechnica.net/wp-content/uploads/2026/07/Bartz-v-Anthropic-Order-Approving-Settlement-7-20-26.pdf) — N.D. Cal., July 20, 2026 (objections, opt-outs, fee award)
...
*Turnpage Digital Markets is an independent claims buyer — not the court, class counsel, or the settlement administrator. Appeal deadlines are determined by the Federal Rules of Appellate Procedure and court orders; consult counsel about your specific situation. This briefing is market intelligence, not legal or financial advice.*
