      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        ...
        {isEditing && (
          <div style={{ padding: "1rem 0.95rem" }}>
            ...
            {!["hero","home-hero","stats-band","our-edge","photo-break","media-banner","cta-banner","bottom-cta","get-quote","cta","faq","testimonials","audience-cards","service-cards","comparison","how-it-works","situations","experience","image-text","rich-text","registration-flow","process-flow","bullet-columns","contact-form"].includes(selectedSection.type) && (
              <div>
