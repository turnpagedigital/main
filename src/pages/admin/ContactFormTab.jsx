...
import { inputStyle, selectStyle, btnStyle, btnPrimaryStyle, iconBtnStyle, formatTime, CenteredMessage, ConfirmDialog, ErrorBanner } from "./shared.jsx";
...
export default function ContactFormTab({ onDirtyChange }) {
  const {
    ...
    endpoint: "/api/admin/contact-form",
