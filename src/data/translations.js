...
export const TRANSLATIONS = {
  ...
  es: {
    ...
    "hero.subtitle":    "Para titulares de derechos con derecho a indemnización — en litigios, acciones colectivas, quiebras, activos bloqueados y derechos de reembolso.",
  ...
  fr: {
    ...
    "hero.subtitle":    "Pour les titulaires de droits à indemnisation — contentieux, recours collectifs, faillites, actifs bloqués et droits à remboursement.",
  ...
  it: {
    ...
    "hero.subtitle":    "Per i titolari di diritti di indennizzo — contenzioso, class action, fallimenti, asset bloccati e diritti di rimborso.",
  ...
  pt: {
    ...
    "hero.subtitle":    "Para titulares de direitos a indenização — litígios, ações coletivas, falências, ativos bloqueados e direitos de reembolso.",
  ...
  ko: {
    ...
    "hero.title_1":     "전략적 자문.",
    "hero.title_2":     "턴키 유동성.",
    "hero.subtitle":    "보상을 받을 권리가 있는 권리자를 위해 — 소송, 집단소송, 파산, 잠긴 자산, 환급권 전반에 걸쳐.",
  ...
  zh: {
    ...
    "hero.title_1":     "战略指导。",
    "hero.title_2":     "一站式流动性。",
    "hero.subtitle":    "面向有权获得赔偿的权利人 — 涵盖诉讼、集体诉讼、破产、锁定资产和退款权利。",
