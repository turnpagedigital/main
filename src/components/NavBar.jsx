...
const PREVIEWS = {
  "ai-copyright": {
    ...
    links: [
      ...
      { label: "Related press & publications", href: hashHref("press") + "?topic=copyright" },
    ],
  ...
  "crypto": {
    ...
    links: [
      ...
      { label: "Related press & publications", href: hashHref("press") + "?topic=crypto" },
    ],
  ...
  "tariff-refunds": {
    ...
    links: [
      ...
      { label: "Related press & publications", href: hashHref("press") + "?topic=tariffs" },
    ],
  ...
  "litigation-finance": {
    ...
    links: [
      ...
      { label: "Related press & publications", href: hashHref("press") + "?topic=litigation" },
    ],
