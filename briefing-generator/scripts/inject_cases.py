...
DOCKET_LIGHT_CSS = """<style>
  ...
  [data-theme="light"] .ud-table thead th { background: #FDFDFE; border: none; box-shadow: 0 6px 14px rgba(163,177,198,0.45), inset 0 1px 0 rgba(255,255,255,0.9); padding-top: 13px; padding-bottom: 13px; }
  [data-theme="light"] .ud-table thead th:first-child { border-top-left-radius: 14px; border-bottom-left-radius: 14px; }
  [data-theme="light"] .ud-table thead th:last-child { border-top-right-radius: 14px; border-bottom-right-radius: 14px; }
