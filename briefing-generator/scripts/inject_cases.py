...
<div class="ud-page">
  ...
  <table class="ud-table">
    <thead><tr>
      <th id="ud-th-time" class="ud-th-filter" style="width:82px" title="Change the lookback window"><span class="ud-th-label">Time · 90 days</span> <span class="ud-th-caret">▾</span></th>
