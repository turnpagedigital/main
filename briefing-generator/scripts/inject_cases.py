...
<div class="ud-page">
  ...
  <div id="uc-merge-bar" class="uc-merge-bar" style="display:none;">
    ...
    <button type="button" id="uc-merge-btn" class="ud-dd-save-btn"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:5px"><path d="M5 4c0 5.5 2.8 7 7 9"/><path d="M19 4c0 5.5-2.8 7-7 9"/><path d="M12 13v7"/><path d="M9 17l3 3 3-3"/></svg>Merge into one event</button>
...
<div id="ud-th-timemenu" class="ud-th-menu" style="display:none;">
  ...
  <table class="ud-table">
    <thead><tr>
      ...
      <th style="width:66px;text-align:center" title="Select all / deselect all visible"><button type="button" id="uc-sel-all" class="uc-selall-btn" title="Select all / deselect all visible for merge" aria-label="Select all / deselect all visible for merge"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><path d="M5 4c0 5.5 2.8 7 7 9"/><path d="M19 4c0 5.5-2.8 7-7 9"/><path d="M12 13v7"/><path d="M9 17l3 3 3-3"/></svg></button><button type="button" id="uc-dismiss-all" class="uc-selall-btn" style="margin-left:7px" title="Dismiss selected events" aria-label="Dismiss selected events"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg></button></th>
    </tr></thead>
    <tbody id="uc-tbody">
