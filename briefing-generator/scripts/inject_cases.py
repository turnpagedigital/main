...
<div id="ud-src-overlay" class="ud-note-overlay" style="display:none;">
  <div class="ud-note-box" style="width:min(680px,100%);">
    ...
    <div class="ud-note-meta">Each source's RSS feed is pulled once a day into the docket feed. Rows appear tagged with the source's label, unassigned until you tie them to a case.</div>
