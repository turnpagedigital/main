...
DOCKET_LIGHT_CSS = """<style>
  ...
  [data-theme="light"] .ud-table thead::after { content: ""; position: absolute; inset: 0; z-index: 0; pointer-events: none; background: #FDFDFE; border-radius: 20px; box-shadow: 0 2px 10px rgba(10,10,10,0.08); }
  ...
  [data-theme="dark"] .ud-table thead::after { content: ""; position: absolute; inset: 0; z-index: 0; pointer-events: none; background: var(--surface); border: 1px solid var(--line-strong); border-radius: 20px; box-shadow: 0 4px 14px rgba(0,0,0,0.4); }
